...
- [`PleasePrompto/notebooklm-skill`](https://github.com/PleasePrompto/notebooklm-skill): fa parlare Claude Code con i tuoi notebook NotebookLM, per interrogare i documenti che ci hai caricato. Archiviato nel settembre 2026, quindi si usa `jacob-bd/gemini-notebook-mcp-cli` qui sopra
